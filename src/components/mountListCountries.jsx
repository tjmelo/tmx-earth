    ...
    return (
        <div className="row">
            ...
            <div className={`col-xs-12 col-sm-6 col-md-3 col-lg-3 mb-3`}>
                ...
                <strong className="text-primary">{Object.values(data.name.nativeName)[0].common || '------'}</strong> <br/>
            </div>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 mb-3">  
                ...
                <strong className="text-primary">{Object.values(data.languages)[0]}</strong>
            </div>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 mb-3">
                ...
                <strong  className="text-primary">
                    ...
                    <sup>{ Object.values(data.currencies)[0].symbol }</sup>
                </strong>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 mb-3">
                ...
                {data.borders ? data.borders.map((border, idx )=> {
            ...
            <div className={`col-xs-12 col-sm-6 col-md-2 col-lg-2 mb-3`}>
                ...
                <strong className="text-primary">{data.tld || '-----'}</strong> <br/>
            </div>

            <div className={`col-xs-12 col-sm-6 col-md-2 col-lg-2 mb-3`}>
                <img width={50} src={data.coatOfArms.svg} alt={data.name.official}/>
            </div>
